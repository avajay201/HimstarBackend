...
from .serializers import RegisterSerializer, OTPVerifySerializer,LoginSerializer,AwardsSerializer, RegisterSerializerPasswordUpdate
from .models import Register, Awards, OTP
